    ...
    <div class="page">
        ...
        <div class="container">
            <div class="filteBar">
                ...
                <div>
                    <el-select v-model="classSelect" size="small" @change="handleCurrentChange">
...
export default {
    ...
    created() {
        this.$http.get(`/teaching/admin/class/list?page=${this.paginations.page_current}&size=${this.paginations.page_size}`
        ).then((res) => { 
            if(res.data.code == "0"){
    ...
    methods: {
        ...
        routeToDetail(row){
            this.$router.push(`/super/viewClass/${row.userId}`)
        },
         handleCurrentChange(page) {
             let url=''
            if(this.classSelect=="全部"){
                url=`/teaching/admin/class/list?page=${this.paginations.page_current}&size=${this.paginations.page_size}&keyword=${this.searchContent}`
            }else{
                url=`/teaching/admin/class/list?classId=${this.classSelect}&page=${this.paginations.page_current}&size=${this.paginations.page_size}&keyword=${this.searchContent}`
            }
