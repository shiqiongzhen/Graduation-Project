    ...
    <div class="page">
        <div class="head">
            ...
            <div class="item">
                ...
                <span>
                    <p><span class="label">班级：</span>{{user.className}}</p>
                    <p><span class="label">学号/工号：</span>{{user.userNumber}}</p>
                </span>
                <span>
                    <p><span class="label">手机号码：</span>{{user.phone}}</p>
                    <p><span class="label">电子邮箱：</span>{{user.mail}}</p>
                </span>
            </div>
        </div>
        <div class="container">
    ...
    methods: {
        ...
        statusOver(){
         ...
         handleCurrentChange(page) {
             let url=''
             if(this.status=='全部'){
                 url=`/teaching/admin/class/info/${this.$route.params.teacherId}?page=${this.paginations.page_current}&size=${this.paginations.page_size}&keyword=${this.searchContent}`
             }else{
                 url=`/teaching/admin/class/info/${this.$route.params.teacherId}?page=${this.paginations.page_current}&size=${this.paginations.page_size}&keyword=${this.searchContent}&status=${this.status}`
             }
